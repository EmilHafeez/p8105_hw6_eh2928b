...
Fit a regression model and plot the model residuals against fitted values, using the original data frame. We'll scale this into the cross-validated approach.
